...
### **Agregados;**
  * Propio MPACK para usar DYOS con menos problemas.
    - Tambien hay una version disponible para Android, reemplazando directamente la carpeta `.gtasa/files/data/script/` del juego
  ...
  * Visualizador de propiedades en el menu.
    - Los valores booleanos (encendido/apagado) apareceran con un 0 de color Rojo, o un 1 Verde.
    - Los valores de un submenu, de color Azul.
    - Los valores de duracion de algo, de color Amarillo.
    - Los valores controlables, de color violeta.
